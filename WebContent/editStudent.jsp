...
<%
    ...
    if (student == null || student.getSchoolId() != schoolId) {
        response.sendRedirect("studentList.jsp");
        return;
    }
...
<head>
    ...
    <title>Edit Student - School Exam System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
                        ...
                        <div class="form-group">
                            ...
                            <select id="classId" name="classId">
                                ...
                                <% for (Class cls : classes) { %>
                                    <option value="<%= cls.getClassId() %>" 
                                            <%= (student.getClassId() != null && student.getClassId() == cls.getClassId() ? "selected" : "") %>>
                                        <%= cls.getClassName() %>
                                    </option>
                                <% } %>
                            </select>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" name="status">
                                ...
                                <option value="PASSED" <%= ("PASSED".equals(student.getStatus()) ? "selected" : "") %>>Passed</option>
                                <option value="FAILED" <%= ("FAILED".equals(student.getStatus()) ? "selected" : "") %>>Failed</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="phoneNumber" name="phoneNumber" 
                                   value="<%= (student.getPhoneNumber() != null ? student.getPhoneNumber() : "") %>">
                        </div>
                    </div>
                    ...
                    <div class="form-row full">
                        <div class="form-group">
                            ...
                            <textarea id="address" name="address"><%= (student.getAddress() != null ? student.getAddress() : "") %></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="fatherName" name="fatherName" 
                                   value="<%= (student.getFatherName() != null ? student.getFatherName() : "") %>">
                        </div>
                        <div class="form-group">
                            <label for="fatherContact">Father's Contact</label>
                            <input type="tel" id="fatherContact" name="fatherContact" 
                                   value="<%= (student.getFatherContact() != null ? student.getFatherContact() : "") %>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="motherName" name="motherName" 
                                   value="<%= (student.getMotherName() != null ? student.getMotherName() : "") %>">
                        </div>
                        <div class="form-group">
                            <label for="motherContact">Mother's Contact</label>
                            <input type="tel" id="motherContact" name="motherContact" 
                                   value="<%= (student.getMotherContact() != null ? student.getMotherContact() : "") %>">
                        </div>
                    </div>
                </div>
