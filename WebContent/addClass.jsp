...
<%
    ...
    if ("POST".equals(request.getMethod())) {
        ...
        if ("add".equals(action)) {
            ...
            classObj.setStatus("ACTIVE");
            
            // Check if class name already exists
            if (ClassDAO.isClassNameExists(classObj.getClassName(), schoolId, 0)) {
                message = "Class name already exists for this school!";
                messageType = "error";
            } else {
                int classId = ClassDAO.addClass(classObj);
                if (classId > 0) {
...
<head>
    ...
    <title>Add Class - School Exam System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>Add New Class</h1>
            <p>Register a new class in your school</p>
        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="className" name="className" 
                                   placeholder="e.g., Class 10-A, Grade 12-B" required>
                        </div>
                        <div class="form-group">
